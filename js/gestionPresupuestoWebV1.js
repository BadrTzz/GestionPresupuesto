...
function mostrarGastos() {
  //funcion papa mostrar los castos en la interfaz
  ...
  gastos.forEach((g) => {
    // lista cada gasto y crea elementos li para cada uno
    ...
    li.textContent = `${g.descripcion} - ${
      g.valor
    } € - ${fechaLocal} - ${g.etiquetas.join(", ")}`; //establece el texto del li con la descripcion , valor ,fecha   y etiquetas del gasto
    ...
    btnBorrar.addEventListener("click", () => {
      // agrega un evento de click al boton para borrar el gasto correspondiente
...
form.addEventListener("submit", (e) => {
  //agrega un evento de submit al formulario para añadir un  nuevo gasto
